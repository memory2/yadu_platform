		    	  ...
		    	  <form id="jbxxForm" method="post" >
		    	     <table style="width:100%;border-collapse:collapse;text-align:center;font-size:12px;" id="cxtj">
		    	     	<tr>
		    	     	  ...
		    	     	  <td><input id="bm" class="easyui-combotree" data-options="valueField:'id',panelHeight:'auto',textField:'text'"  name="ssbm" style="width:120px;"/>  
		    	     	  </td>
		    	     	  <td style="width:80px;">姓名</td>
		    	     	  <td><input id="xm" class="easyui-combobox" name="xm" style="width:120px;"  data-options="panelHeight:'auto'" /></td>
