		    	  ...
		    	  <form id="jbxxForm" method="post" >
		    	     <table style="width:100%;border-collapse:collapse;text-align:center;font-size:12px;" id="cxtj">
		    	     	<tr>
		    	     	  ...
		    	     	  <td><input id="jbzgs" class="easyui-combobox" name="dept"   data-options="multiple:'true', panelHeight:'400', valueField:'id',textField:'text',url:'servlet/OaAction?method=zd&zdmc=申请使用证件类别&zdlb=1'" /></td>
		    	     	<tr>
		    	     </table>
		    	  </form>
		    	</div> <br/>  
