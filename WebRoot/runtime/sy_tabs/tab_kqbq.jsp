...
<title>人员信息管理</title> 
	...
	<script type="text/javascript">
	  ...
	  function cx(){
		  ...
		  var url = 'servlet/OaAction?method=sy_kqbq&sqksrq='+sqksrq+'&sqjsrq='+sqjsrq+'&jbzgs='+jbzgs+'&sqr='+sqr;
          var gridID = "dg_kqbq";
          var gridBT = "考勤补签";
...
<body>
		    	     ...
		    	     <table style="width:100%;border-collapse:collapse;text-align:center;font-size:12px;" id="cxtj">
		    	     	<tr>
		    	     	  ...
		    	     	  <td>
							 ...
							 <input id="jbzgs" class="easyui-combobox" name="dept"   data-options="multiple:'true', panelHeight:'auto', valueField:'id',textField:'text',url:'servlet/OaAction?method=zd&zdmc=具体补卡次序&zdlb=1'" />
				...
				<table id="dg_kqbq" title="考勤补签信息列表" class="easyui-datagrid" style="width:100%;height:390px" 
