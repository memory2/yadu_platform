        ...
        <form id="ff" method="post">
            <table style="margin: 0 auto">
                ...
                <tr>
                    <td>数量:</td>
                    <td>
                        <input id="amount" name="amount" class="easyui-numberspinner " required="true" value="0" min="0"
                               data-options="increment:1" style="width:100px;"></input>个
                    </td>
                </tr>
                <tr>
                    <td>备注:</td>
                    <td>
                        <input id="remark" name="remark" class="easyui-textbox " name="message" required="true"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-ok'"
                           id="addForm">提交</a>
                        <a href="javascript:void(0)" id="resetForm" class="easyui-linkbutton"
