...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            cx();
            $('#btn_search_xssb_zzsq').bind('click', function () {
                cx();
            });
        });
        ...
        function cx() {
            ...
            var jejs = $("#jejs").val();
            //alert(sqksrq+"--"+jbzgs);
            var url = 'servlet/OaAction?method=sy_xssb_zzsq&sqksrq=' + sqksrq + '&sqjsrq=' + sqjsrq + '&jeqs=' + jeqs + '&jejs=' + jejs + '&sqr=' + sqr;
            var gridID = "dg_xssb_zzsq";
            var gridBT = "转账申请";
...
<div title="付款申请信息" style="padding:10px;">
    ...
    <a id="btn_search_xssb_zzsq" class="easyui-linkbutton" data-options="iconCls:'icon-search'">查询</a>

    <br/><br/>

    <table id="dg_xssb_zzsq" title="销售三部转账信息列表" class="easyui-datagrid" style="width:100%;height:390px;"
        ...
        <tr>
            ...
            <th field="zzje" width=100px;>转账金额</th>
