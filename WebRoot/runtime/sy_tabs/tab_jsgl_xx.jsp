    ...
    <form id="jbxxForm" method="post">
        <table style="width:100%;border-collapse:collapse;text-align:center;font-size:12px;margin:8px;" id="cxtj">
            <tr>
                ...
                <td><input id="fid" class="easyui-combobox" name="fid" style="width:130px;"
                           data-options="panelHeight:'100', valueField:'id',textField:'text',url:'servlet/KqAction?method=zd&zdmc=父角色名称&zdlb=0'"/>
                </td>
                <td style="width:100px;">角色图标</td>
                <td><input class="easyui-combobox" id="tb" style="width:130px;"
                           data-options="panelHeight:'auto',valueField: 'id',textField: 'text',data: [{text: '一级菜单图标',id: 'icon-menu1'},{text: '二级菜单图标',id: 'icon-menu2'}]"/>
                </td>
            </tr>
            <tr>
