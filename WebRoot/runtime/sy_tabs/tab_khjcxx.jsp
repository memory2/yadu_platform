		         ...
		         <div title="khjcxx"  id="khjcxx">
		    	  ...
		    	  <form id="khglform" method="post" name="khglform">
		    	     <table style="width:90%;border-collapse:collapse;font-size:14px;margin-left:5%;" id="khjcxx">
		    	     	<tr>
		    	     	  <td style="font-size:14px;font-weight:bold;text-align:left;padding-left:10px;" colspan='8'>客户基础信息</td></td>
		    	     	</tr>
		    	     	<tr>
		    	     	  <td style="width:10%;">姓名</td>
		    	     	  <td style="width:15%;"><input id="xm" class="easyui-textbox"  name="xm" /></td>
		    	     	  <td style="width:10%;">性别</td>
		    	     	   <td > <input id="xb" style="width:100px;" class="easyui-combobox"   value="" name='xb' data-options=" panelHeight:'auto', valueField:'id',textField:'text',data: [{id: '0',text: '男'},{id: '1',text: '女'}]" /></td>
		    	        ...
		    	        <tr>
		    	     	...
		    	     	<table style="width:90%;border-collapse:collapse;font-size:14px;margin-left:5%"" id="glryxx">
		    	     	<tr>
		    	     ...
		    	     <table style="width:90%;border-collapse:collapse;font-size:14px;margin-left:5%"" id="glywxx">
		    	     	<tr>
		    	        ...
		    	        <tr>
		    	     	...
		    	     	<tr>
		    	          ...
		    	          <input id="wlxx" class="easyui-textbox" data-options="multiline:true" name="wlxx" style="width:80%;height:100px;" /></td>
		    	     	</tr>
		    	     	<tr>
		    	       	  <td  colspan='6' style="text-align:left;padding:5px;">
		    	       	  <div style="text-align:left;margin:5px;"><font>客户描述信息</font></div>
		    	       	  <input id="khms" class="easyui-textbox" data-options="multiline:true" name="khms" style="width:80%;height:150px;" /></td>
		    	     	</tr>
		    	     </table>
		    	  </form>
		    </div> 
