...
<body>
<div id="ss" style="display:none;margin-bottom:10px;margin-top:10px;"><a id="btn_cx_sbxx" class="easyui-linkbutton" data-options="iconCls:'icon-back'" onclick="fhcx()">返回查询</a></div>
