        ...
        <form id="jbxxForm" method="post">
            <table style="width:100%;border-collapse:collapse;text-align:center;font-size:12px;" id="cxtj">
                <tr>
                    ...
                    <td><input id="nf" class="easyui-combobox" name='nf' value=""
                               data-options=" panelHeight:'auto', valueField:'id',textField:'text',url:'servlet/OaAction?method=zd&zdmc=年份&zdlb=1'"/>
                    </td>
                    <td style="width:100px;">选择月份</td>
                    <td><input id="yf" class="easyui-combobox" value="" name='yf'
                               data-options=" panelHeight:'auto', valueField:'id',textField:'text',url:'servlet/OaAction?method=zd&zdmc=月份&zdlb=1'"/>
                    </td>
                    ...
                    <td><input id="xm" class="easyui-combobox" name="xm" style="width:190px;"
