	...
	<script type="text/javascript">
	  ...
	  $(function(){
		 ...
		 mask = $("#maskOfProgressImage");
	        ...
	        var cx_flag = false;
	        var tj_flag = false;
	        $("#nf").combobox('setValue',getYear());
	    	$("#yf").combobox('setValue',getMonth());
		    //cx(getYy());
	  ...
	  function cx1(rq){
		  ...
		  //if(cx_flag){
			  ...
			  var n = $("#nf").combobox('getValue');
		  	  var y = $("#yf").combobox('getValue');
			  ...
			  //alert(bm+":"+xm);
			  var url = 'servlet/OaAction?method=kqxx&kqsj='+rq+'&xm='+xm+'&bm='+bm;
	          $.ajax({  
	              type: 'POST',
	              dataType: "json",
	              url:url,
	              ...
	              success: function(data){
	            		  ...
	            		  //$("#dg_kqxx").html(JSON.stringify(data));
	            		   ...
	            		   var kqy = $("#nf").combobox('getValue')+"年"+$("#yf").combobox('getValue')+"月";
	            		  ...
	            		  for(var key in data){	
		        			  ...
		        			  //alert(JSON.stringify(data));
		            		      ...
		            		      if(xm!=""&&xm!=null&&xm!=undefined){
		            		    	  ...
		            		    	  kqtj+= "<tr><td>"+js+"</td><td>"+bm+"</td><td>"+gh+"</td><td>"+xm+"</td><td>"+mqts+"</td><td>"+ykqts+"</td><td>3</td><td>"+gxts+"</td><td>"+qjts+"</td><td>"+qjts_hj+"</td><td>"+qjts_sj+"</td><td>"+qjts_gs+"</td><td>"+byjb+"</td><td>"+cdcs+"</td><td>"+cdcs_15+"</td><td>"+ztcs+"</td><td>"+bqcs+"</td><td>"+hjcs+"</td></tr>";
		            		      }else{
		            		    	  js--;
		            		      }
	                   }
	  ...
	  function cx(rq){
		  var url = 'servlet/OaAction?method=kqxx&kqsj='+rq;
		  $.ajax({  
              type: 'POST',
              dataType: "json",
              url:url
 	 ...
 	 <style>
     tr td{border:solid #add9c0; border-width:1px 1px 1px 1px; padding:3px 0px;text-align:center;font-size:12px;white-space:0;}
     .bt_td{height:35px;}
		        ...
		        <div>
		    	  <form id="jbxxForm" method="post" >
		    	     <table style="width:100%;border-collapse:collapse;text-align:center;font-size:12px;" id="cxtj">
		    	     	<tr>
		    	     	  <td style="width:100px;text-align:center">选择年份</td>
		    	     	  <td> <input id="nf" class="easyui-combobox"  name='nf' value="" data-options=" panelHeight:'auto', valueField:'id',textField:'text',url:'servlet/OaAction?method=zd&zdmc=年份&zdlb=1'" />
		    	     	  </td>
		    	     	  <td style="width:100px;">选择月份</td>
		    	     	  <td> <input id="yf" class="easyui-combobox" value="" name='yf' data-options=" panelHeight:'auto', valueField:'id',textField:'text',url:'servlet/OaAction?method=zd&zdmc=月份&zdlb=1'" /></td>
		    	     	   <td style="width:100px;text-align:center">所属部门</td>
		    	     	  <td><input id="bm" class="easyui-combotree" data-options="valueField:'id',panelHeight:'260',textField:'text'"  name="ssbm" style="width:190px;"/>  
		    	     	  </td>
		    	     	  <td style="width:100px;">姓名</td>
		    	     	  <td><input id="xm" class="easyui-combobox" name="xm" style="width:190px;"  data-options="panelHeight:'260'" /></td>
		    	     	<tr>
		    	     </table>
		    	  </form>
		    	</div> <br/>   
