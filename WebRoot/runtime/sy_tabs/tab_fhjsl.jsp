        ...
        <form id="jbxxForm" method="post">
            <table style="width:100%;border-collapse:collapse;text-align:center;font-size:12px;" id="cxtj">
                <tr>
                    ...
                    <td style="width:450px;text-align:center"><input id="sqksrq" type="text" class="easyui-datebox"
                                                                     style="width:150px;"></input> 至
                        <input id="sqjsrq" type="text" class="easyui-datebox" style="width:150px;"></input>
                    </td>
                    <td style="width:250px;"><a id="btn_search_wfh" class="easyui-linkbutton"
                                                data-options="iconCls:'icon-search'">未发货查询</a></td>
                    <td style="width:250px;"><a id="btn_search_cfh" class="easyui-linkbutton"
                                                data-options="iconCls:'icon-search'">超期发货查询</a></td>
                    <td style="width:350px;"><a id="btn_search_jsl" class="easyui-linkbutton"
                                                data-options="iconCls:'icon-search'">及时率统计</a>
                        <a id="btn_search_jsltj" class="easyui-linkbutton" data-options="iconCls:'icon-dload'"
                           style="display:none;margin-left:30px;">导出统计</a>
                    </td>
                <tr>
            </table>
        </form>
