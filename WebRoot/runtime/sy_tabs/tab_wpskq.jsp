	...
	<script type="text/javascript">
	  ...
	  $(function(){
		 ...
		 mask = $("#maskOfProgressImage");
	        ...
	        if((bmmc=='信息部'||bmmc=='人力资源部'||txm=="10703"||txm=="10665"||txm=="10269"||txm=="11048")||(zwjb!="10012"&&zwjb!=="10013"&&zwjb!=="10014"&&zwjb!=="10016"&&zwjb!=="10018"&&zwjb!=="10022")){
	        	$('#bm').combobox({disabled:false});
	        	$('#xm').combobox({disabled:false});
	        }

	        if(txm=="10778"||txm=="10855"||txm=="10948"||txm=="10952"||txm=="11076"||txm=="11004"){
	        	$('#xm').combobox({disabled:false});
	        }
	        
        	$("#bm").combotree('setValue',bmdm);
        	if(txm!="10554"&&txm!="10703"&&bmmc!="信息部"&&bmmc!="人力资源部"&&bmmc!="威浦仕人事部"){
	    ...
	    function cx(rq){
	    	var kqy = rq.substring(0,4)+"年"+rq.substring(5,7)+"月";
			  //if(cx_flag){
				  ...
				  //alert(bm+":"+xm);
				  var url = 'servlet/KqAction?method=kqxx_wps_pc&cxsj='+rq+'&cxxm='+xm+'&cxbm='+bm;
				  $.ajax({  
		              type: 'POST',
		              dataType: "json",
		              url:url,
