    ...
    <script type="text/javascript">
        ...
        function cx() {
            ...
            if (false) {
                ...
                getDataGird1(url, gridID, gridBT, updUrl, delUrl, '98%', '85%');
            }
...
<div title="客户信息查询" style="padding:10px;">
    <div>
        <form id="jbxxForm" method="post">
            <table style="width:100%;border-collapse:collapse;text-align:center;font-size:12px;" id="cxtj">
                <tr>
                    ...
                    <td><input id="khxb" style="width:100px;" class="easyui-combobox" value="" name='khxb'
