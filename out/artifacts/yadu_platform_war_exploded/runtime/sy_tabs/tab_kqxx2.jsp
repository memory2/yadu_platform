...
<title>人员信息管理</title> 
  ...
  %>
	...
	<script type="text/javascript">
	 ...
	 #nf,#yf{width:70px}
	 #dg_kqxx{width:39000px!important; border-collapse:collapse; padding-right:20px;}
	 ...
	 .nr_bt{width:79px;}
	 .xh{width:40px;}
	 #kqy_tj{font-size:14px;font-weight:bold;padding:5px;width:100000px}
		    	  ...
		    	  <form id="jbxxForm" method="post" >
		    	     <table style="width:100%;border-collapse:collapse;text-align:center;font-size:12px;" id="cxtj">
		    	     	<tr>
		    	     	  ...
		    	     	  <td  style="width:180px;"><input id="bm" class="easyui-combotree" data-options="valueField:'id',panelHeight:'260',textField:'text'"  name="ssbm" style="width:150px;"/>  
		    	     	  </td>
