...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            cx();
            $('#btn_search_yfzxhkxx').bind('click', function () {
                cx();
            });
        });
        ...
        function cx() {
            ...
            var jejs = $("#jejs").val();
            //alert(sqksrq+"--"+jbzgs);
            var url = 'servlet/OaAction?method=sy_yfzx_hkxx&sqksrq=' + sqksrq + '&sqjsrq=' + sqjsrq + '&jeqs=' + jeqs + '&jejs=' + jejs + '&sqr=' + sqr;
            var gridID = "dg_yfzx_hkxx";
            var gridBT = "研发中心汇款信息";
...
<div title="研发中心汇款信息" style="padding:10px;">
    <div>
        <form id="jbxxForm" method="post">
            <table style="width:100%;border-collapse:collapse;text-align:center;font-size:12px;" id="cxtj">
                <tr>
                    ...
                    <td><input id="sqksrq" type="text" class="easyui-datebox" style="width:130px;"></input> 至
                        <input id="sqjsrq" type="text" class="easyui-datebox" style="width:130px;"></input>
                    </td>
                    <td style="width:100px;">申请人</td>
                    <td><input id="sqr" class="easyui-textbox" name="sqr" style="width:130px;"/></td>
    ...
    <a id="btn_search_yfzxhkxx" class="easyui-linkbutton" data-options="iconCls:'icon-search'">查询</a>
    <br/><br/>

    <table id="dg_yfzx_hkxx" title="汇款信息列表" class="easyui-datagrid" style="width:100%;height:390px;"
        ...
        <tr>
            ...
            <th field="wpmc" width=120px;>物品名称</th>
            <th field="ggxh" width=100px;>规格型号</th>
            <th field="sl" width=50px;>数量</th>
            <th field="dj" width=80px;>单价</th>
            <th field="zj" width=80px;>总价</th>
            <th field="hjje" width=120px;>合计汇款金额</th>
            <th field="khh" width=200px;>开户行</th>
            <th field="hm" width=200px;>户名</th>
            <th field="zh" width=150px;>账号</th>
