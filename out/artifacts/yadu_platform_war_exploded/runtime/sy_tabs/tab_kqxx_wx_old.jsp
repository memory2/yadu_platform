...
<div title="考勤信息" style="padding:10px;" >
		    	...
		    	<font style="font-size:12px;">公司类别：</font><input id="dwbs" name="dwbs"  class="easyui-combobox" data-options="panelHeight:'auto', valueField:'id',textField:'text',data:[{'id':5,'text':'亚都实业'},{'id':6,'text':'威浦仕'}]"  style="width:100px;"/>
		    	</td><td>
