	...
	<script type="text/javascript">
	  $(function(){
		  ...
		  if(bm!='信息部'&&bm!='财务部'&&bm!='财务中心'&&kqh!='00002'){
		    ...
		    cx();
	        $('#btn_search_fybx').bind('click', function(){    
	            cx();
	        });
	        
	        $('#btn_tj_fybx').bind('click', function(){ 
	        	$("#chartContainer").show();
	        	$("#fy").hide();
	        	$("#ss").show(); 
	        	tj();
	  ...
	  function cx(){
		  ...
		  var jejs = $("#jejs").val();
		  //alert(sqksrq+"--"+jbzgs);
          var url = 'servlet/OaAction?method=sy_fybx&sqksrq='+sqksrq+'&sqjsrq='+sqjsrq+'&jeqs='+jeqs+'&jejs='+jejs+'&sqr='+sqr;
          var gridID = "dg_fybx";
          var gridBT = "费用报销信息";
...
<div id="chartContainer" style="text-align:center;"></div>
	<script type="text/javascript">
	  ...
	  function tj(){
		  ...
		  var lb = "tj_fybx&ksrq="+sqksrq+"&jsrq="+sqjsrq;
		  getTjt(lb,"年费用报销统计","Column3D","200000");
	  }

	</script>
		         <div title="费用报销信息" style="padding:10px;" id="fy">		    	
		    	<div>
				...
				<a id="btn_search_fybx" class="easyui-linkbutton" data-options="iconCls:'icon-search'">查询</a>
				<a id="btn_tj_fybx" class="easyui-linkbutton" data-options="iconCls:'icon-redo'">统计图</a>
				
				<br/><br/>
				<table id="dg_fybx" title="费用报销信息列表" class="easyui-datagrid" style="width:100%;height:390px;" 
				  collapsible="true" rownumbers="true"  striped="true" fitColumns="true"   singleSelect="true" nowrap="false"> 
					<thead> 
						...
						<th field="tbrq"   width=120px;>填报日期</th> 
						<th field="bxxm"   width=300px;>报销项目</th> 
						<th field="bxje"   width=120px;>报销金额</th> 
						<th field="yjkje"   width=120px;>原借款金额</th>
						<th field="ytkje"   width=120px;>应退款金额</th>  
