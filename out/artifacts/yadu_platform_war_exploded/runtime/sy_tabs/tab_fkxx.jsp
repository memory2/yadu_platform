	...
	<script type="text/javascript">
	  $(function(){
		  ...
		  if(bm!='信息部'&&bm!='财务部'&&bm!='财务中心'&&kqh!='00002'){
		    ...
		    cx();
	        $('#btn_search_fkxx').bind('click', function(){    
	            cx();
	        }); 
	        
	        $('#btn_tj_fkxx').bind('click', function(){ 
	        	$("#chartContainer").show();
	        	$("#fk").hide();
	        	$("#ss").show(); 
	        	tj();
	  ...
	  function cx(){
		  ...
		  var jejs = $("#jejs").val();
		  //alert(sqksrq+"--"+jbzgs);
          var url = 'servlet/OaAction?method=sy_fkxx&sqksrq='+sqksrq+'&sqjsrq='+sqjsrq+'&jeqs='+jeqs+'&jejs='+jejs+'&sqr='+sqr;
          var gridID = "dg_fkxx";
          var gridBT = "付款信息";
...
<div id="chartContainer" style="text-align:center;"></div>
	<script type="text/javascript">
	  ...
	  function tj(){
		  ...
		  var lb = "tj_fkxx&ksrq="+sqksrq+"&jsrq="+sqjsrq;
		  getTjt(lb,"年付款信息统计","Column3D","20000");
	  }


	</script>

		         <div title="借款信息" style="padding:10px;" id="fk">		    	
		    	<div>
				...
				<a id="btn_search_fkxx" class="easyui-linkbutton" data-options="iconCls:'icon-search'">查询</a>
				<a id="btn_tj_fkxx" class="easyui-linkbutton" data-options="iconCls:'icon-redo'">统计图</a>
				<br/><br/>
				
				<table id="dg_fkxx" title="财务部付款信息列表" class="easyui-datagrid" style="width:100%;height:390px;" 
				  collapsible="true" rownumbers="true"  striped="true" fitColumns="true"   singleSelect="true" nowrap="false"> 
					<thead> 
						...
						<th field="fksy"   width=300px;>付款事由</th> 
						<th field="fkje"   width=120px;>付款金额</th> 
						<th field="dj"   width=120px;>单据及附件</th>
						</tr> 
					</thead> 
				</table>   
		    </div> 
