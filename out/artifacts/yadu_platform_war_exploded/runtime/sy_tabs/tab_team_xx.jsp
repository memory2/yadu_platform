    ...
    <form id="jbxxForm" method="post">
        <table style="width:100%;border-collapse:collapse;text-align:center;font-size:12px;" id="cxtj">
            ...
            <tr>
                ...
                <td colspan=3><input id="tname" class="easyui-textbox" name="tname" required=true style="width:685px;"/>
                </td>
            </tr>
            <tr>
                <td style="width:100px;">组成员</td>
                <td colspan=3><input id="tmember" class="easyui-textbox" name="tmember" required=true
                                     data-options="multiline:true" style="width:685px;height:120px;"/></td>
            </tr>
            <tr>
                <td style="width:100px;text-align:center">公司类别</td>
                <td>
                    <input id="gslb" name="gslb" class="easyui-combobox"
                           data-options="panelHeight:'auto', valueField:'id',textField:'text',data:[{'id':'41','text':'亚都实业'},{'id':'61','text':'威浦仕(行政)'},{'id':'71','text':'威浦仕(车间)'},{'id':'51','text':'迈迪克'}]"
                           style="width:685px;"/>
                </td>
