	...
	<script type="text/javascript">
	  ...
	  function cx(rq){
		  ...
		  if(gs==41){
			  ...
			  url = 'servlet/KqAction?method=kqxx_wps_wx&cxsj='+rq+'&wxid='+wxid+'&gslb=61';
		  }else{
			  alert("服务异常，请联系信息部！");
		  }
		  //if(cx_flag){
	 ...
	 #nf,#yf{width:70px}
	 #dg_kqxx{border-collapse:collapse; padding-right:20px;}
	 ...
	 #fhdb{font-size:12px;text-align:left;padding-left:15px;display:none}
...
<div title="考勤信息" style="padding:10px;" >
		    	...
		    	<tr><td style="display:none1">
		    	<font style="font-size:12px;">公司类别：</font><input id="dwbs" name="dwbs"  class="easyui-combobox" data-options="panelHeight:'auto', valueField:'id',textField:'text',data:[{'id':'41','text':'亚都实业'},{'id':'61','text':'威浦仕'},{'id':'51','text':'迈迪科'}]"  style="width:100px;"/>
		    	</td><td>
		    	<a id="sykq" class="easyui-linkbutton" data-options="iconCls:'icon-search'">上月考勤</a>
		    	<a id="bykq" class="easyui-linkbutton" data-options="iconCls:'icon-search'" style="display:none">本月考勤</a></td>
		    	</tr>
		    	</table>
