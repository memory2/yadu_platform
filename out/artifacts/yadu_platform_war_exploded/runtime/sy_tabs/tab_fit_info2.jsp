                        ...
                        editor: {
                            ...
                            options: {
                                ...
                                onSelect: function (data) {
                                    ...
                                    var thisTarget = $("#tt").datagrid("getEditor", {
                                        "index": rowIndex,
                                        "field": "packName"
                                    }).target;
...
<div id="tb" style="padding:5px;height:auto">
    <div style="margin-bottom:5px">
        <a href="javascript:void(0)" id="addFun" class="easyui-linkbutton" iconCls="icon-add" plain="true"
           onclick="append()">添加</a>
        <a href="javascript:void(0)" id="delFun" class="easyui-linkbutton" iconCls="icon-remove" plain="true">删除</a>
        <a href="javascript:void(0)" id="saveFun" class="easyui-linkbutton" iconCls="icon-save" plain="true"
           onclick="accept()">保存</a>
        <!-- <a href="javascript:void(0)" id="saveFun" class="easyui-linkbutton" iconCls="icon-redo"   plain="true" onclick="importData()">导入</a> -->
        <a href="javascript:void(0)" id="saveFun" class="easyui-linkbutton" iconCls="icon-dload" plain="true"
           onclick="ExporterExcel()">导出</a>
        <a href="javascript:void(0)" id="saveFun" class="easyui-linkbutton" iconCls="icon-print" plain="true"
           onclick="printExcel()">打印</a>

        <a href="javascript:void(0)" class="easyui-linkbutton" id="reject" iconCls="icon-undo" plain="true"
           onclick="reject()">撤销</a>
        <a href="javascript:void(0)" id="refreshFun" class="easyui-linkbutton" iconCls="icon-reload" plain="true"
...
<div id="importExcel" closed="true" class="easyui-dialog" title="导入excel文件"
    ...
    <form id="uploadExcel" method="post" enctype="multipart/form-data" style="padding:10px;">
        选择文件：　<input id="excel" name="excel" class="easyui-filebox" style="width:200px"
                     data-options="prompt:'请选择文件...'">
    </form>
    <div style="text-align: center; padding: 5px 0;">
        <a href="javascript:void(0)" id="booten" class="easyui-linkbutton" plain="true" οnclick="uploadExcel1()"
