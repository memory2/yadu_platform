		    	     ...
		    	     <table style="width:100%;border-collapse:collapse;text-align:center;font-size:12px;" id="cxtj">
		    	     	<tr>
		    	     	 <td style="width:100px;">所属公司</td>
		    	     	  <td > <input id="gs" style="width:180px;" class="easyui-combobox" value="" name='gs' data-options=" panelHeight:'auto', valueField:'id',textField:'text',data: [{id: '41',text: '亚都'},{id: '51',text: '迈迪克'},{id: '61',text: '威浦仕'}]" /></td>
		    	     	  
		    	     	  <td style="width:100px;text-align:center">所属部门</td>
		    	     	  <td><input id="bm" class="easyui-combotree" data-options="valueField:'id',panelHeight:'auto',textField:'text'"  name="bm" style="width:180px;"/>  
		    	     	  </td>
		    	     	  <td style="width:100px;">姓名</td>
		    	     	  <td><input id="xm" class="easyui-combobox" name="xm" style="width:180px;"  data-options="panelHeight:'auto'" /></td>
		    	     	  <td style="width:100px;">角色</td>
		    	     	  <td>
		    	     	   <input id="js" class="easyui-combobox" name="js" style="width:180px;"  data-options="panelHeight:'auto', valueField:'id',textField:'text',url:'servlet/KqAction?method=zd&zdmc=父角色名称&zdlb=0'" />
		    	     	  </td>
		    	     	<tr>
		    	     </table>
		    	  </form>
