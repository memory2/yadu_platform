...
<div title="人员信息" style="padding:10px;width:98%;margin-top:20px;">
            ...
            <table style="width:100%;border-collapse:collapse;text-align:center;font-size:12px;" id="cxtj">
                <tr>
                    ...
                    <td style="width:250px;">
                        <input id="gslb" name="gslb" class="easyui-combobox" style="width:150px"
                               data-options="panelHeight:'auto', valueField:'id',textField:'text',data:[{'id':'1','text':'亚都实业'},{'id':'2','text':'威浦仕'},{'id':'3','text':'迈迪科'}]"
                               style="width:100px;"/>
                    </td>
                    <td style="width:150px;text-align:center">到职日期</td>
                    <td style="width:400px;text-align:center"><input id="kssj" type="text" class="easyui-datebox"
                                                                     style="width:150px;"></input> 至
                        <input id="jssj" type="text" class="easyui-datebox" style="width:150px;"></input>
                    </td>
                    <td style="width:150px;text-align:center">雇佣状态</td>
                    <td style="width:250px;">
                        <input id=ryzt name="ryzt" class="easyui-combobox" style="width:150px"
                               data-options="panelHeight:'auto', valueField:'id',textField:'text',data:[{'id':'10','text':'在职'},{'id':'20','text':'离退'},{'id':'30','text':'辞职'}]"
                               style="width:100px;"/>
                    </td>
                <tr>
            </table>
    ...
    <div style="text-align:center">
        ...
        <a id="btn_dc" class="easyui-linkbutton" data-options="iconCls:'icon-search'" style="margin-left:20px;">导出表格</a>
    </div>
    <br/><br/>
    <div><font style="color:red;font-size:14px;font-family:微软雅黑">备注：人员统计以【出生日期】不为空且数据合法为准。</font></div>
    <br/>
    <div id="dg_rsxx"></div>
...
<script type="text/javascript">
    ...
    function cx() {
        ...
        var content = '<chart caption="' + Tgslb + Tryzt + '员工年龄结构饼状图" baseFontSize="16" showNames="1" showBorder="0" baseFont="微软雅黑"  outCnvBaseFontSize="100" bgColor="EEF3FA" canvasBgColor="EEF3FA" formatNumberScale="0" canvasBorderThickness="0"  showValues="1" showYAxisValues="0" showLegend="0"  labelDisplay="STAGGER" showPlotBorder="1" numDivLines="0"  borderThickness ="0" yAxisName="" xAxisName="" numberSuffix="人" plotSpacePercent="50">';
        var myChart = null;

        var url = "servlet/U8Action?method=rsnl&gslb=" + gslb + "&kssj=" + kssj + "&jssj=" + jssj + "&ryzt=" + ryzt;
        $.ajax({
            type: 'POST',
            dataType: "json",
            url: url,
            ...
            success: function (data) {
                ...
                if (data.length > 0) {
                    ...
                    var lb6 = data[0]['lb6'];
                    var zs = data[0]['zs'];
                    var nljg = "<table id='rsgl'><tr><td  colspan=4 class='zbt'>" + Tgslb + Tryzt + "员工年龄结构表格</td></tr>" +
                        "<tr><td  colspan=4 class='rs'>" + dzrq + Tryzt + "员工总数：" + zs + "人</td></tr>" +
                        "<tr><td  class='xh'>序号</td><td  class='bt'>年龄范围</td><td  class='bt'>总人数</td><td  class='bt'>百分比</td></tr>" +
                        "<tr><td class='nr'>1</td><td class='nr'>25岁以下</td><td class='nr'>" + lb1 + "</td><td class='nr'>" + (lb1 / zs * 100).toFixed(2) + "%</td></tr>" +
                        "<tr><td class='nr'>2</td><td class='nr'>25-35岁</td><td class='nr'>" + lb2 + "</td><td class='nr'>" + (lb2 / zs * 100).toFixed(2) + "%</td></tr>" +
                        "<tr><td class='nr'>3</td><td class='nr'>35-45岁</td><td class='nr'>" + lb3 + "</td><td class='nr'>" + (lb3 / zs * 100).toFixed(2) + "%</td></tr>" +
                        "<tr><td class='nr'>4</td><td class='nr'>45-55岁</td><td class='nr'>" + lb4 + "</td><td class='nr'>" + (lb4 / zs * 100).toFixed(2) + "%</td></tr>" +
                        "<tr><td class='nr'>5</td><td class='nr'>55-65岁</td><td class='nr'>" + lb5 + "</td><td class='nr'>" + (lb5 / zs * 100).toFixed(2) + "%</td></tr>" +
                        "<tr><td class='nr'>6</td><td class='nr'>65岁以上</td><td class='nr'>" + lb6 + "</td><td class='nr'>" + (lb6 / zs * 100).toFixed(2) + "%</td></tr>" +
                        "</table>";
                    $("#dg_rsxx").html(nljg);

                    content += '<set label="25岁以下"  value="' + lb1 + '" /><set label="25-35岁"  value="' + lb2 + '" /><set label="35-45岁"  value="' + lb3 + '" /><set label="45-55岁"  value="' + lb4 + '" /><set label="55-65岁"  value="' + lb5 + '" /><set label="65岁以上"  value="' + lb6 + '" /></chart>';
