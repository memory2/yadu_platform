		    	  ...
		    	  <form id="jbxxForm" method="post" >
		    	     <table style="width:100%;border-collapse:collapse;text-align:center;font-size:12px;" id="cxtj">
		    	     	<tr>
		    	     	  ...
		    	     	  <td><input id="jbzgs" class="easyui-combobox" name="dept"   data-options=" panelHeight:'auto', valueField:'id',textField:'text',url:'servlet/OaAction?method=zd&zdmc=员工调动类别&zdlb=1'" /></td>
		    	     	<tr>
		    	     </table>
		    	  </form>
		    	</div> <br/>  
