        ...
        <table style="width:100%;border-collapse:collapse;text-align:center;font-size:12px;" id="cxtj">
            <tr>
                ...
                <td><input id="bm" class="easyui-combotree"
                           data-options="valueField:'id',panelHeight:'150',textField:'text'" name="bm"
                           style="width:260px;"/>
                </td>
                <td style="width:100px;">姓名</td>
                <td><input id="xm" class="easyui-combobox" name="xm" style="width:260px;"
                           data-options="panelHeight:'150'"/></td>

            </tr>
            <tr>
                <td style="width:100px;">日志标题</td>
                <td colspan=3><input id="rzbt" class="easyui-textbox" name="rzbt" required=true style="width:685px;"/>
                </td>
            </tr>
            <tr>
                <td style="width:100px;">日志内容</td>
                <td colspan=3><input id="rznr" class="easyui-textbox" name="rznr" required=true
