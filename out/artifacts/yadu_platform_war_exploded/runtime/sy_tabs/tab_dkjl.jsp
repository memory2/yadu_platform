		    	...
		    	<div>
		    	  <form id="jbxxForm" method="post" >
		    	     <table style="width:100%;border-collapse:collapse;text-align:center;font-size:12px;" id="cxtj">
		    			...
		    			选择年份：</td>
		    			<td><input id="cxn" name="cxn"  class="easyui-combobox" required="true" data-options="panelHeight:'auto', valueField:'id',textField:'text',data:[{'id':'2019','text':'2019年'},{'id':'2020','text':'2020年'},{'id':'2021','text':'2021年'}]"  style="width:100px;"/>
		    			</td >
		    	     	 <td style="width:100px;">
		    			选择月份：</td>
		    			...
		    			<td style="width:100px;">输入日期</td>
		    	     	  <td><input id="cxr" class="easyui-textbox" name="cxr"  style="width:100px;"/></td></td > 
		    	     	  ...
		    	     	  <td><a id="btn_search_ydtx" class="easyui-linkbutton" data-options="iconCls:'icon-search'">查询</a></td>
		    	     	<tr>
		    	     </table>
		    	  </form>
		    	</div> <br/>  
