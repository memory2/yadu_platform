...
<div title="人员信息" style="padding:10px;">
        ...
        <form id="jbxxForm" method="post">
            <table style="width:100%;border-collapse:collapse;text-align:center;font-size:12px;" id="cxtj">
                ...
                <tr>
                    ...
                    <td><input id="xb" name="xb" class="easyui-combobox"
                               data-options="multiple:'false', panelHeight:'auto', valueField:'id',textField:'text',data:[{'id':1,'text':'男'},{'id':2,'text':'女'}]"
                               style="width:170px;"/></td>
                    <td style="width:100px;">婚姻状况</td>
                    <td><input id="hyzk" name="hyzk" class="easyui-combobox"
                               data-options="multiple:'false', panelHeight:'auto', valueField:'id',textField:'text',data:[{'id':1,'text':'未婚'},{'id':2,'text':'已婚'}]"
                               style="width:170px;"/></td>
                    <td style="width:100px;text-align:center">人员状态</td>
                    <td><input id="ryzt" name="ryzt" class="easyui-combobox"
                               data-options="multiple:'false', panelHeight:'auto', valueField:'id',textField:'text',data:[{'id':10,'text':'在职'},{'id':30,'text':'离职'}]"
                               style="width:170px;"/></td>
                <tr>
            </table>
        </form>
    ...
    <a id="btn_search" class="easyui-linkbutton"
       data-options="iconCls:'icon-search'">查询</a>&nbsp;&nbsp;&nbsp;&nbsp;<font id="sx">自动刷新</font>&nbsp;<span
        id="span1">10</span>
