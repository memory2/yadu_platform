...
<title>人员信息管理</title> 
	...
	<script type="text/javascript">
	  ...
	  function cx(){
		  ...
		  var jbzgs = $("#jbzgs").val();
		  //alert(sqksrq+"--"+jbzgs);
          var url = 'servlet/OaAction?method=sy_ylb_ccxx&sqksrq='+sqksrq+'&sqjsrq='+sqjsrq+'&jbzgs='+jbzgs+'&sqr='+sqr;
          var gridID = "dg_ylb_ccxx";
          var gridBT = "原料部出差信息";
...
<body>
				...
				<table id="dg_ylb_ccxx" title="出差信息列表" class="easyui-datagrid" style="width:100%;height:400px;" 
