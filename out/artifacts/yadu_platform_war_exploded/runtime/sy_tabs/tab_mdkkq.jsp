	...
	<script type="text/javascript">
	  ...
	  $(function(){
		 ...
		 mask = $("#maskOfProgressImage");
	        ...
	        if((bmmc=='信息部'||bmmc=='迈迪科综合办'||txm=="10665"||txm=="10269")||(zwjb!="10012"&&zwjb!=="10013"&&zwjb!=="10014"&&zwjb!=="10016"&&zwjb!=="10018"&&zwjb!=="10022")){
	        	$('#bm').combobox({disabled:false});
	        	$('#xm').combobox({disabled:false});
	        }

        	$("#bm").combotree('setValue',bmdm);
        	if(txm!="10554"&&txm!="10966"&&txm!="11019"&&bmmc!="信息部"&&bmmc!="迈迪科综合办"){
		    	  ...
		    	  <form id="jbxxForm" method="post" >
		    	     <table style="width:100%;border-collapse:collapse;text-align:center;font-size:12px;" id="cxtj">
		    	     	<tr>
		    	     	  ...
		    	     	  <td  style="width:220px;"><input id="bm" class="easyui-combotree" data-options="valueField:'id',panelHeight:'auto',textField:'text'"  name="ssbm" style="width:180px;"/>  
		    	     	  </td>
