    ...
    <script>
        $('#dg').datagrid({
            ...
            detailFormatter: function (rowIndex, rowData) {
                var values = [];
                values.push('<div style="float:left;width:20%;">');
                values.push("<img src=" + rowData.photo
                    + "   />");
                values.push('</div>');
...
<table id="dg" class="easyui-datagrid" title="配件列表" style="width:700px;height:auto"
       data-options="
				iconCls: 'icon-edit',
				singleSelect: true,
				toolbar: '#tb',
    ...
    <thead>
    <tr>
        <th data-options="field:'itemid',width:80">包名</th>
