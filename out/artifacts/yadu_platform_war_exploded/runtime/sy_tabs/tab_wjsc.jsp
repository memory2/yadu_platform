...
<div style="margin-left:370px">
    <div class="easyui-panel" title="Excel数据上传" style="width:60%;padding:30px 70px 50px 70px">
        ...
        <div style="margin-bottom:20px">
            <div>选择Excel文件:</div>
            <input class="easyui-filebox" name="uploadFile" id="uploadFileid"
                   data-options="prompt:'选择文件',buttonText:'&nbsp;选&nbsp;择&nbsp;',required:true" style="width:100%">
        </div>
        <div style="margin-bottom:20px">
            <tr>
                ...
                <td style="text-align:left">
		            <span class="radioSpan">
		                <label><input type="radio" name="drms" value="1" checked="checked"
                                      id="ms1">添加记录到目标表</input></label>
