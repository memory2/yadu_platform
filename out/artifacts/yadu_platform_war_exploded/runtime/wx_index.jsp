...
<title>OA信息管理</title> 
  ...
  %>
    ...
    $(function(){
    	 ...
    	 var kqSrc = 'runtime/sy_tabs/tab_kqxx.jsp';
        ...
        $('#tc').bind('click', function(){ 
        	if(confirm("您确定要退出吗?")){
        	   $.ajax({
        	         type:"post",
        	         url:"servlet/OaAction?method=tc",
                     success:function(msg){  
                    	 window.close();
                    	//window.location.href = "http://10.0.10.100:58080/yadu_OA/runtime/login/login.jsp";
                     },error:function(){
        	                 alert("系统报错，请联系管理员！");
        	            	 //错误处理
        	         }
    ...
    //动态添加左侧菜单核心方法1
      function getMenu(){
          $.ajax({  
              type: 'POST',
              dataType: "json",
              url:'servlet/OaAction?method=cd',
    ...
    <style>
    body{margin: 0 auto;  padding:0; overflow:auto;height:100%;} 
      .menu_a{
        font-size:12px;margin-left:5px;margin-right:5px;text-decoration:none;color:#0099FF;cursor:hand;height:25px;
      }
      .divOver{
         background:#FFE48D;
      }
      #jrtq{
      	width:500px;float:left;margin-left:50px;font-weight:100!important;margin-top:-5px;
      }
      #dqry{font-weight:100!important;text-align:right!important; margin-right:50px;color:#0099FF;}
...
<div id="cc" class="easyui-layout" style="width:75%;height:720px;margin-left:200px;">  
    <div data-options="region:'north'" style="height:130px;background-color:#68B2D7;"  title="<div style='float:left;color:#0099FF;font-weight:100;' id='dqsj'></div><div id=jrtq ></div><div  id=dqry> 工号：<%=kqh %> | 姓名：<%=xm %> | 部门：<%=bmmc %> | <font id='tc' style='cursor:pointer;font-weight:700;'>退出</font></div>" >
	      <div style="height:100px;">
	      		<div style="color:#00438D;font-size:32px;font-weight:bold;padding-top:25px;padding-left:50px;">
	      			<div>
	      				...
	      				<font style="vertical-align:middle;">OA数据分析系统<font style="font-size:20px">--亚都集团</font></font>
	      			</div>
	      		</div>
	      </div>
    ...
    <div data-options="region:'west',title:'导航菜单'" style="width:150px">
         <div id="wnav" class="easyui-accordion" style="width:100%;height:100%;" data-options="fit:true,border:false,animate:true,plain:true">   
		</div>  
    </div>   
    <div data-options="region:'center'" >
		<div id="tabs" class="easyui-tabs" style="width:100%;height:100%;">   
		         <!--欢迎标签 START-->        
		         <div title="考勤查询" style="padding:5px;text-align:center;">
    ...
    <div style="height:30px;background-color:#E8F1FF;text-align:center;padding-top:7px;color:#0099FF;" data-options="region:'south'" >技术支持：信息部 | 联系电话：83960</div>
  </div> 
 </body>  
</html> 