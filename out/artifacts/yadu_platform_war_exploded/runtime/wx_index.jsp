...
<div id="cc" class="easyui-layout" style="width:75%;height:720px;margin-left:200px;">
    <div data-options="region:'north'" style="height:130px;background-color:#68B2D7;"
         title="<div style='float:left;color:#0099FF;font-weight:100;' id='dqsj'></div><div id=jrtq ></div><div  id=dqry> 工号：<%=kqh %> | 姓名：<%=xm %> | 部门：<%=bmmc %> | <font id='tc' style='cursor:pointer;font-weight:700;'>退出</font></div>">
